...
-- Create schema
CREATE SCHEMA IF NOT EXISTS lad_dev;
...
CREATE TABLE tenant_invitations (
  ...
  -- Constraints: One pending invitation per email per tenant
  CONSTRAINT tenant_invitations_unique_pending UNIQUE(tenant_id, email, accepted_at)
);
...
CREATE INDEX idx_tenant_invitations_token ON tenant_invitations(invitation_token);
CREATE INDEX idx_tenant_invitations_expires_at ON tenant_invitations(expires_at);
first_name, last_name, primary_tenant_id, is_active, email_verified, created_at) VALUES
('00000000-0000-0000-0000-000000000001', 'admin@demo.com', '$2a$10$YourHashedPasswordHere
-- TRIGGERS
-- ============================================================================
...
('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'chat_with_ai', 'ai_assistant
...
-- Demo user
INSERT INTO users (id, email, password_hash, name, first_name, last_name, primary_tenant_id, is_active, email_verified, created_at) VALUES
('00000000-0000-0000-0000-000000000001', 'admin@demo.com', '$2a$10$YourHashedPasswordHere', 'Demo Admin', 'Demo', 'Admin', '00000000-0000-0000-0000-000000000001', true, true, NOW());
...
-- Demo capabilities
INSERT INTO user_capabilities (user_id, tenant_id, capability_key, enabled, created_at) VALUES
('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'apollo.search', true, NOW()),
('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'apollo.email_reveal', true, NOW()),
('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'view_overview', true, NOW()),
('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'view_call_logs', true, NOW()),
('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'chat_with_ai', true, NOW());
...
COMMENT ON TABLE user_capabilities IS 'Granular permissions for RBAC';
COMMENT ON TABLE tenant_invitations IS 'Invitation flow for adding users to tenants';
